...
python plot_time_by_ratio_percentile.py certifair/fair_no_maxk/quant_run_20251014T155455.json certifair/baseline_no_maxk/quant_run_20251014T190907.json --fill-percentiles 20,80 --bins 20 --no-title --labels 'Fair model,Baseline model'
...
python plot_max_ratio_combined.py certifair/fair_no_maxk/quant_run_20251015T205531.json certifair/baseline_no_maxk/quant_run_20251015T192207.json --output certifair/ --labels 'Fair model,Baseline model' --bins 40 --no-title
...
echo "Plotting quant/qual MSE..."
 python plot_epsilon_flag_alignment.py certifair --series "Fair model=fair*none" --series "Baseline model=base*none" --output certifair/fair_vs_base_alignment.png
