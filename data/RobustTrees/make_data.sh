...
if [ ! -f predictions/ijcnn/test_pred.csv ]; then
    ...
    popd
    python predict.py -d=repo/data/ijcnn1s0.t -m predictions/ijcnn/ijcnn.model -f predictions/ijcnn/test_pred.csv -c 2 # Save predictions as csv
else
...
if [ ! -f predictions/ijcnn.unrob/test_pred.csv ]; then
	...
	popd
	python predict.py -d=repo/data/ijcnn1s0.t -m predictions/ijcnn.unrob/ijcnn.unrob.model -f predictions/ijcnn.unrob/test_pred.csv -c 2 # Save predictions as csv
else
