...
INPUT_CSV="$PROJECT_ROOT/data/text/amazon/amazon-judge-gemma-4-26b-a4b-it_embed-pplx-embed-v1-0-6b_temp-t0_5class_n1000.csv"
RESULTS_DIR="$PROJECT_ROOT/results/quantitative/text_amazon/5class_argmax"
