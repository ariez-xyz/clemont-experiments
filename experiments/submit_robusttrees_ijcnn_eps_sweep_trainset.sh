...
# Main Configuration
export robust_input="../data/RobustTrees/predictions/ijcnn/train_pred.csv"
export unrob_input="../data/RobustTrees/predictions/ijcnn.unrob/train_pred.csv"
export results_base="../results/slurm_robusttrees_ijcnn_eps_sweep_train_set"
