...
INPUT_CSV="$PROJECT_ROOT/data/text/toxic-chat/toxic-chat-judge-gemma-4-26b-a4b-it_embed-pplx-embed-v1-0-6b_temp-t0_2class_n1000.csv"
RESULTS_DIR="$PROJECT_ROOT/results/quantitative/text_toxic_chat/2class_argmax"
...
python "$SCRIPT_DIR/quant_runner.py" \
  ...
  --pred-cols "$PRED_COLS" \
  --ignore-cols "row_id,example_id,source_row,conv_id,prompt_hash,toxicity_label,jailbreaking_label,human_annotation,openai_moderation,user_input,judge_answer,first_token,first_token_logprob,top_logprobs_json,label_logprob_floor,judge_finish_reason,judge_model_returned,judge_response_id,judge_error,logprob_0,logprob_0_source,logprob_1,logprob_1_source" \
