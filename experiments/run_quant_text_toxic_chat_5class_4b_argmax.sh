...
INPUT_CSV="$PROJECT_ROOT/data/text/toxic-chat/toxic-chat-judge-gemma-4-26b-a4b-it_embed-pplx-embed-v1-4b_temp-t0_5class_n2000.csv"
RESULTS_DIR="$PROJECT_ROOT/results/quantitative/text_toxic_chat/5class_4b_argmax"
